...
function mh_magazine_lite_customize_register($wp_customize) {
        ...
        public function render_content() {  ?>
        	...
        	<p class="mh-upgrade-title">
        		<span class="customize-control-title">
        			<?php esc_html_e('Need more features and options?', 'mh-magazine-lite'); ?>
        		</span>
        	</p>
        	<p class="mh-upgrade-text">
        		<span class="textfield">
        			<?php esc_html_e('If you run an awesome website and need more advanced features, options and custom widgets, you can upgrade to the premium version of this theme which comes with great additional features to customize your website.', 'mh-magazine-lite'); ?>
        		</span>
			</p>
			<p class="mh-upgrade-button">
				<a href="http://www.mhthemes.com/themes/mh/magazine/" target="_blank" class="button button-secondary">
					<?php esc_html_e('Click here for premium features', 'mh-magazine-lite'); ?>
				</a>
			</p><?php
        }
    }
	...
	$wp_customize->add_section('mh_magazine_lite_upgrade', array('title' => esc_html__('Upgrade to Premium', 'mh-magazine-lite'), 'priority' => 3, 'panel' => 'mh_theme_options'));
	...
	$wp_customize->add_control(new MH_Customize_Upgrade_Control($wp_customize, 'premium_version_upgrade', array('section' => 'mh_magazine_lite_upgrade', 'settings' => 'mh_magazine_lite_options[premium_version_upgrade]', 'priority' => 1)));
