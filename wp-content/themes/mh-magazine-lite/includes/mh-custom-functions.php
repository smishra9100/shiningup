		...
		echo '<div class="mh-custom-header" role="banner">' . "\n";
			echo '<a href="' . esc_url(home_url('/')) . '" title="' . esc_attr(get_bloginfo('name')) . '" rel="home">' . "\n";
				echo '<div class="mh-site-logo" role="banner">' . "\n";
					if ($header_img) {
						echo '<img style="float:right" class="mh-header-image" src="' . esc_url($header_img) . '" height="' . esc_attr(get_custom_header()->height) . '" width="' . esc_attr(get_custom_header()->width) . '" alt="' . esc_attr($header_title) . '" />' . "\n";
					}
